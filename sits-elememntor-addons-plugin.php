...
function sits_elementor_addons_init()
{
    ...
    // ✅ Make sure the path is correct (note the slash after __DIR__)
    require_once __DIR__ . '/widgets/sitsel-sticky-controls.php';

    // ✅ These hooks should be added *after Elementor is loaded*
    add_action('elementor/init', function () {
        add_action('elementor/element/container/section_layout/after_section_end', 'sitsel_add_sticky_controls');
        add_action('elementor/frontend/container/before_render', 'sitsel_before_render_sticky');
    });
    ...
    add_action('elementor/frontend/after_enqueue_scripts', function () {
        ...
        wp_enqueue_script('sitsel-sticky-enhancer.js', plugin_dir_url(__FILE__) . 'assets/js/sitsel-sticky-enhancer.js', ['jquery'], '1.0', true);
        ...
        wp_enqueue_style('sitsel-sticky-enhancer.css', plugin_dir_url(__FILE__) . 'assets/css/sitsel-sticky-enhancer.css');
    });
